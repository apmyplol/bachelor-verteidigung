var RevealPointer = function () {
  ...
  return function () {
    ...
    function l(o) {
      var n;
      null == (t = o.pointer || {
      }).key ? t.key = 'q' : t.key = t.key.toLowerCase(),
      null != t.pointerSize &&
      'number' == typeof t.pointerSize ||
      (t.pointerSize = 12),
      null != t.tailLength &&
      'number' == typeof t.tailLength ||
      (t.tailLength = 10),
      null != t.color &&
      'string' == typeof t.color ||
      (t.color = 'red'),
      null != t.alwaysVisible &&
      'boolean' == typeof t.alwaysVisible ||
      (t.alwaysVisible = !1),
      null != t.opacity &&
    ...
    function r() {
      ...
      1 !== i.scale ? (
        ...
        n.style.width = ''.concat(t.pointerSize, 'px'),
        n.style.height = ''.concat(t.pointerSize, 'px')
      )
    }
    function c(e) {
      a.x = e.pageX,
    ...
    return {
      ...
      init: function (e) {
        var o;
        l(e.getConfig()),
        t.alwaysVisible ? s() : e.addKeyBinding({
          keyCode: t.keyCode,
          key: t.key
        }, (function () {
          s()
        ...
        e.on(
          ...
          (
            function (e) {
              ...
              o = e.color,
              null != n &&
              (n.style.backgroundColor = null != o ? o : t.color)
            }
          )
        ),
